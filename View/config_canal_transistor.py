...
class Ui_frmConfigCanalTransistor(object):
    def setupUi(self, frmConfigCanalTransistor):
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(350, 20, 90, 190))
        ...
        self.label_12.setGeometry(QtCore.QRect(10, 130, 80, 16))
        self.label_12.setObjectName("label_12")
        self.txTempoCanal_4 = QtWidgets.QLineEdit(self.groupBox_4)
        self.txTempoCanal_4.setGeometry(QtCore.QRect(10, 150, 70, 21))
        self.txTempoCanal_4.setObjectName("txTempoCanal_4")
        self.ckbHabilitaModulo = QtWidgets.QCheckBox(frmConfigCanalTransistor)
        self.ckbHabilitaModulo.setGeometry(QtCore.QRect(180, 270, 121, 20))
        ...
        self.rbtBaseMinutos.setGeometry(QtCore.QRect(250, 240, 120, 20))
    ...
    def retranslateUi(self, frmConfigCanalTransistor):
        ...
        self.label_12.setText(_translate("frmConfigCanalTransistor", "TEMPO(min)"))
